export { default as AppBugReports } from './ProductQuantity';
...
export { default as AppItemOrders } from './EmployeeQuantity';
export { default as AppNewsUpdate } from './AppNewsUpdate';
export { default as AppNewUsers } from './SalaryProductMin';
...
export { default as AppWeeklySales } from './SalaryProductMax';
